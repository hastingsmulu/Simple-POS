...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="POS/app-assets/css/pages/login-register.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1"><img src="POS/app-assets/images/logo/robust-logo-dark.png" alt="branding logo"></div>
                </div>
