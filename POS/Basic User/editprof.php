	...
	<div class="row match-height">
		<div class="col-lg-12 col-xl-6">
			...
			<div id="accordionWrapa1" role="tablist" aria-multiselectable="true">
				...
				<img src="../assets/img/user.png"  class="" data-toggle="tooltip" data-placement="top" title="Click to Edit your Profile details here." data-original-title="Tooltip on right"/>
				<ul class="px-0 list-unstyled">
					<li class="font-medium-3 text-bold-800 " data-toggle="tooltip" data-placement="top" title="Click to Edit your Profile details here." data-original-title="Tooltip on right"><code><?=$_SESSION['SESS_FIRSTNAME']?> <?=$_SESSION['SESS_LASTNAME']?></code></li>
					<li class="teal font-medium-1 text-bold-300">Email: <?=$_SESSION['SESS_EMAIL']?></li>
...
<input type="hidden"  name="shopname" value="<?=$_SESSION['SESS_SHOP']?>">
						</fieldset>
