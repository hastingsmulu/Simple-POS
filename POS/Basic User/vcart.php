...
<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="totals" readonly value="<?php echo ($total); ?>"  class="form-control" placeholder="total" >
										  </div>
    									</div>
									<div class="col-md-6">
										<div class="form-group">
...
echo '<br><span class="tag tag-warning">Enter Phone Number Below </span><br><input type="text" name="phno" value="Null" class="form-control"   id="phno">';
}
?>
										</div>
									</div>
...
<div class="col-md-6">
										<div class="form-group">
<label  class="font-medium-3">Comments</label>
<input name="suspend" class="   form-control" value="
					<?php
						//initialize total
						$total = 0;
						if(!empty($_SESSION['cart'])){
