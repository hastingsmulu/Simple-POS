...
// save query
$sql = "INSERT INTO sales_order (date,cart_details,qty,pmeth,refno,mpesacode,total,slpn,customer,pno,status) VALUES (:i,:a,:m,:f,:h,:r,:b,:c,:s,:pm,:n)";
$q = $db->prepare($sql);
$q->execute(array(':i'=>$k,':a'=>$a,':m'=>$index,':f'=>$xx,':h'=>$h,':r'=>$mcode,':b'=>$e,':c'=>$pop,':s'=>$noob,':pm'=>$phome,':n'=>$p));
