...
<div class="col-md-6 col-sm-12 text-xs-center text-md-left">
				...
				<ul class="px-0 list-unstyled">
					<li class="font-medium-3 text-bold-800 " data-toggle="tooltip" data-placement="top" title="Click to Edit your Shop details here." data-original-title="Tooltip on right">  <code><?=$_SESSION['SESS_SHNAME']?></code></li><hr>
<p>Address</p>
			<li><i class="icon-map-marker danger"> </i> <code><?=$_SESSION['SESS_SLOCATION']?><br> <?=$_SESSION['SESS_SADDRESS']?></code></li><hr>
<p>Contacts</p>
			<li><i class="icon-android-call danger"> </i><code> <?=$_SESSION['SESS_SCONTACT']?></code></li>
			<li><i class="icon-android-mail danger"><code><?=$_SESSION['SESS_SSEMAIL']?></code> </i> </li>	
				</ul>
			</div> </a>
					</div>
					<div id="accordion2" role="tabpanel" aria-labelledby="heading2" class="card-collapse collapse in" aria-expanded="false">
						<div class="card-body">
							<div class="card-block text-md-right">
								<form class="form-horizontal form-simple" method="post" action="editshopdetail.php" >

							<input type="text" class="form-control hidden form-control-lg input-lg " name="id" value="<?=$_SESSION['SESS_SSHOP_ID']?>">
