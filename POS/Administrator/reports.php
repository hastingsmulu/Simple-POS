...
echo '<span class="tag tag-default tag-success font-medium-1 ">'.$row['mpesacode'].'</span> <br><br>Phone #: => <p class="tag tag-default tag-primary font-medium-2 "> '.$r['pno'].'</p><br><br> Amount => <p class="tag tag-default tag-info font-medium-2 "> ';
...
echo '<span class="tag tag-default font-medium-1 "  >'.$r['status'].'</span>'; 
        ...
        echo '<button class="btn btn-lg btn-danger">
              <a class="tag tag-danger " href="updatestats.php?id='.$r['id'].'" class="button" title="">
              <span class="font-medium-1 " data-toggle="tooltip" data-placement="bottom" data-original-title="Cart is '.$r['status'].'! Click to update Paid" >'.$r['status'].'
        </span>
        </button>
        </a>
'; 
...
?></a></td>
			...
			<td class="table-bordered" > <a href="delete.php?id=<?php echo $r['id']; ?>"  title="Click To Delete"><i class="icon-android-delete" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Tooltip on top"></i></a></td>
...
<table id="resultTable"  class="table table-hover table-responsive  mb-0" data-responsive="table">
	...
	<tbody>
			...
			<?php
				include('../connect.php');
				$result = $db->prepare("SELECT * FROM sales_order ORDER BY id DESC ");
				$result->execute();
...
echo '
            <a class="tag tag-info" href="updatestats.php?id='.$row['id'].'" class="button" title="">
            <br>
            <span class="font-medium-1 " data-toggle="tooltip" data-placement="bottom" data-original-title="Cart is '.$row['status'].'! Click to update Paid" >'.$row['status'].'
            </span>
            </a>
'; 
}
...
?>
			...
			<td class="table-bordered" > <a href="delete.php?id=<?php echo $row['id']; ?>"   title="Click To Delete"><i class="icon-android-delete" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Tooltip on top"></i></a></td>
			</tr>
			<?php
				}
unset($db);
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("Sure you want to delete this Purchased cart? There is NO undo!"))
		  {
