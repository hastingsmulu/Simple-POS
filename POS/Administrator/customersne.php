      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h4 class="card-title teal font-medium-5 text-bold-800" style="text-align:left;"><i class="icon-user5 font-medium-4"> </i> Customer Info </h4>
          </div>
...
<div class="table-responsive">
	...
	<thead>
		<tr>
			...
			<th class="teal font-medium-2 text-bold-300">Address </th>
             ...
             <th class="teal font-medium-2 text-bold-300">Action </th>
	...
	<tbody>
			...
			<td><a href="deletecstmr.php?id=<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete"><i class="icon-android-delete" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Tooltip on top"></i></a>
