...
<form action="saveediteexpe.php" method="post">
									...
									<input type="text" placeholder="<?php echo $row['category']; ?>" name="code" value="<?php echo $row['category']; ?>"class="form-control border-primary"><br><br>
								
									<label>Amount:</label> <code> <?php echo $row['amount']; ?></code> 
									<input type="text" placeholder="<?php echo $row['amount']; ?>" name="name" value="<?php echo $row['amount']; ?>" class="form-control border-primary" />
								<br><br>
								<label>Comment:</label> <code> <?php echo $row['comment']; ?></code> 
									<input type="text" placeholder="<?php echo $row['comment']; ?>" name="cost" value="<?php echo $row['comment']; ?>" class="form-control border-primary" /><br><br>
